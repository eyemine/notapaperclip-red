  ...
  return (
    <div className="page-wrap">
      ...
      <div style={{ display: 'flex', gap: '0.4rem', marginBottom: '2rem', flexWrap: 'wrap' }}>
        {['ghostagent', 'ghostagent-alpha', 'swarm-1'].map(ex => (
          <button key={ex} className="btn-secondary" style={{ fontSize: '0.7rem', padding: '0.25rem 0.625rem', borderRadius: 99 }}
            onClick={() => { setQuery(ex); setStatus('idle'); }}>
            {ex}
          </button>
        ))}
      </div>
      ...
      <footer className="site-footer">
        ...
        <div>Alignment watchdog for <a href="https://paperclip.ing" target="_blank" rel="noopener noreferrer">Paperclip.ing</a> companies · ERC-8004 on Gnosis Chain</div>
      </footer>
